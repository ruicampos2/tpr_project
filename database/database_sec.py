...
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('hoodie', 'Item 1'))
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('canecas', 'Item 2'))
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('tshirt', 'Item 3'))
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('pins', 'Item 4'))
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('canetas', 'Item 5'))
# c.execute("INSERT INTO posts (title, name) VALUES (?, ?)", ('stickers', 'Item 6'))
